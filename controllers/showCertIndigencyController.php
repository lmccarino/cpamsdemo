...
$command ="select certindigency from assistdetail where idassistdetails = $idassistdetails";
$row = getrow($command);
...
if (stristr(PHP_OS, 'WIN')) {
	...
	// Removed By: Teddy C. 09/14/2023 09:11.
...
if (file_exists($fullpath)) {
    ...
    $fileContent = file_get_contents("https://lingapblob.blob.core.windows.net/indigency/" . $fname);
