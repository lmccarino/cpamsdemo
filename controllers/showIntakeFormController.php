...
$command ="select intakeform from assistdetail where idassistdetails = $idassistdetails";
$row = getrow($command);
...
if (file_exists($fullpath)) {
    ...
    $fileContent = file_get_contents("https://lingapblob.blob.core.windows.net/intake/" . $fname);
