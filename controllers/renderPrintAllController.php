...
include 'printAllController.php';
...
class MYPDF extends tcpdf {   
    ...
    public function Header() {    		
        $image_file = '../images/cmo-header-blue.jpg';
        $this->Image($image_file, 0, 0, 0, 0, 'JPG', '', 'T', false, 300, 'C', false, false, 0, false, false, false);   
    } 
...
$printdetails = new PrintAll();
$gldetails = $printdetails->getDetails($id);


$documentdate = (isset($gldetails['dateReissue'])) ? date('F d, Y', strtotime($gldetails['dateReissue'])) : date('F d, Y', strtotime($gldetails['dateApproved']));
